...
export default function Contact() {
  return (
    <>
      <Helmet>
        <title>Contact | John Lundun</title>
        <meta name="description" content="Reach out to John Lundun to discuss your brand's audio identity, film scores, or production needs." />
      </Helmet>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="bg-surface border border-border-subtle rounded-[3rem] p-10 md:p-20 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 shadow-2xl shadow-black/20">
            ...
            <div>
              ...
              <p className="text-lg text-text-muted font-light mb-12 leading-relaxed">
                Available for original composition, licensing, and full audio post-production. Let's elevate your story.
              </p>

              <div className="space-y-10">
                <div>
                  <h3 className="text-xs font-medium tracking-widest text-accent uppercase mb-3">Direct Connect</h3>
                  <a href="mailto:LundunJohn@gmail.com" className="text-2xl font-light hover:text-accent transition-colors block">LundunJohn@gmail.com</a>
                  <a href="tel:+27760866806" className="text-xl font-light hover:text-accent transition-colors block mt-2">+27 76 086 6806</a>
                </div>
